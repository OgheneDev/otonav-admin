    ...
    <div className="space-y-6">
      ...
      {loadingOrders ? (
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {/* Total */}
          <div
            className="bg-white rounded-2xl border p-5 flex flex-col items-center justify-center gap-1"
                    ...
                    return (
                      <tr key={rider.riderId}>
                        ...
                        <td>
                          <div className="flex items-center gap-2">
                            <div
                              className="flex-1 max-w-[100px] h-1.5 rounded-full overflow-hidden"
